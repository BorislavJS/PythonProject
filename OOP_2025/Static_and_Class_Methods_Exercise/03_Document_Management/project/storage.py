...
class Storage:
    ...
    def delete_category(self, category_id):
        self.__del_object(category_id, self.categories)

    def delete_topic(self, topic_id):
        self.__del_object(topic_id, self.topics)

    def delete_document(self, document_id):
        self.__del_object(document_id, self.documents)
    ...
    def __del_object(self, object_id, object_collection):
        curr_object = self.__find_object(object_id, object_collection)
        if curr_object:
