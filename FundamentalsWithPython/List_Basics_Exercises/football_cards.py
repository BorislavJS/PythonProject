...
first_team_player_count = initial_player_count - len(first_team_sent_off_players)
second_team_player_count = initial_player_count - len(second_team_sent_off_players)

print(f"Team A - {first_team_player_count}; Team B - {second_team_player_count}")
